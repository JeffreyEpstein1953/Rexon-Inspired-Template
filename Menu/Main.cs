    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            // Title and FPS
                ...
                text.text = PluginInfo.Name+" [P"+(pageNumber).ToString()+"]";
                text.fontSize = 1;
                ...
                component.sizeDelta = new Vector2(0.275f, 0.045f);
                component.position = new Vector3(0.06f, 0f, 0.16f);
            ...
            // Buttons
                // Disconnect
                    if (disconnectButton)
                    {
                        ...
                        disconnectbutton.transform.localScale = new Vector3(0.09f, 1f, 0.15f);
                        ...
                        colorChanger.colorInfo = buttonColors[3];
                        colorChanger.Start();
                ...
                // Page Buttons
                    ...
                    gameObject.transform.localScale = new Vector3(0.09f, 0.15f, 0.9f);
                    gameObject.transform.localPosition = new Vector3(0.56f, 0.62f, -0.03f);
                    ...
                    colorChanger.colorInfo = buttonColors[2];
                    colorChanger.Start();
                    text = new GameObject
                    {
                        transform =
                    ...
                    component.localPosition = Vector3.zero;
                    component.sizeDelta = new Vector2(0.825f, 0.125f);
                    component.localPosition = new Vector3(0.064f, 0.185f, -0.01f);
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.transform.parent = menu.transform;
            gameObject.transform.rotation = Quaternion.identity;
            gameObject.transform.localScale = new Vector3(0.09f, 0.82f, 0.098f);
            gameObject.transform.localPosition = new Vector3(0.56f, 0f, 0.28f - offset * 1.15f);
            ...
            component.localPosition = new Vector3(.064f, 0, .105f - offset / 2.3f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        }
